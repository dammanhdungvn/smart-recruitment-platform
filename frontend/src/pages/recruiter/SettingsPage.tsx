    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Quản lý thông tin công ty và cài đặt tài khoản nhà tuyển dụng
        </Typography>
      </Box>
        ...
        <Stack spacing={3}>
          ...
          <form onSubmit={handleSubmit}>
            <Stack spacing={3}>
              <TextField
                fullWidth
                label="Tên công ty / Người đại diện"
              ...
              <Alert severity="info" icon={<Business />}>
                Thông tin công ty sẽ được hiển thị trong các tin tuyển dụng của
                bạn
              </Alert>
